...
Scenario: Checkers should repeat in x
  ...
  Then pattern_at<pattern, point<0, 0, 0>> = white
    ...
    And pattern_at<pattern, point<2.01, 0, 0>> = white
...
Scenario: Checkers should repeat in z
  ...
  Then pattern_at<pattern, point<0, 0, 0>> = white
    ...
    And pattern_at<pattern, point<0, 0, 2.01>> = white

Scenario: Checkers should repeat in all dimensions
  Given pattern ← checkers_pattern<white, black>
  Then pattern_at<pattern, point<3.01, 3.01, 3.01>> = black
